...
function initDb() {
  ...
  try {
    ...
    db.exec("UPDATE leads SET call_status = 'failed' WHERE (call_duration = 0 OR call_duration IS NULL OR transcript IS NULL OR transcript = '') AND call_status = 'completed';");
  } catch (e) {}
}
